...
const EditBusDetails = () => {
  ...
  let{bus_no,bus_type,source,destination,duration,pickup_time,pickup_date,price,rating,drivername,email,phone_no,boarding_points,dropping_points}=editBusInfo;
